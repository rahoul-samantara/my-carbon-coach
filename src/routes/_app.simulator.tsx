...
const levers: Lever[] = [
  {
    key: "transit",
    label: "Subway days per week",
    unit: "days",
    max: 5,
    default: 1,
    perUnitKg: -4.2,
    icon: Train,
    hint: "Replace solo car commutes with the subway.",
  },
  {
    key: "car",
    label: "Car trips per week",
    unit: "trips",
    max: 10,
    default: 6,
    perUnitKg: 3.6,
    icon: Car,
    hint: "Single-occupancy driving emissions.",
  },
  {
    key: "delivery",
    label: "Food deliveries per week",
    unit: "orders",
    max: 10,
    default: 4,
    perUnitKg: 1.8,
    icon: UtensilsCrossed,
    hint: "Includes packaging + last-mile.",
  },
  {
    key: "wfh",
    ...
    perUnitKg: -2.1,
    icon: Home,
    hint: "Avoided commute, partial office energy.",
  },
];
...
function Simulator() {
  ...
  const projected = useMemo(
    () => levers.reduce((sum, l) => sum + values[l.key] * l.perUnitKg, 0),
    [values],
  );
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <label htmlFor={l.key} className="font-medium block truncate">
                        {l.label}
                      </label>
        ...
        <aside className="col-span-12 lg:col-span-5 space-y-4">
          ...
          <div className="rounded-3xl bg-card border border-border ring-soft p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              ...
              <span className="text-foreground font-semibold">38 kg CO₂e/mo</span> — that's nearly
              7% of your budget.
            </p>
            <button
