      ...
      <div className="max-w-5xl w-full mx-auto px-6 flex-1 flex flex-col">
        <div className="mt-2 mb-8">
          ...
          <div
            ...
            aria-valuemin={0}
            aria-valuemax={100}
            aria-label="Onboarding step completion progress"
          >
            <div
  ...
  const summary = [
    {
      ...
      color: "var(--chart-1)",
      note:
        scores.transScore > 150
          ? "Your largest contributor — biggest opportunity."
          : "Great, transportation emissions are low!",
    },
    {
      label: "Food",
      ...
      note:
        answers.diet === "meat"
          ? "A shift toward flexitarian could save ~15%."
          : "Excellent diet selection.",
    },
    {
      label: "Energy",
      impact: scores.energyScore > 100 ? "High" : scores.energyScore > 50 ? "Medium" : "Low",
      color: "var(--chart-3)",
      note: `Household sizing of ${answers.household || 1} offsets baseline energy.`,
    },
    {
      label: "Shopping",
      impact: scores.shopScore > 80 ? "High" : scores.shopScore > 40 ? "Medium" : "Low",
      color: "var(--chart-4)",
      note: "Ordering in bundles reduces packaging impact.",
    },
  ];
      ...
      <div className="max-w-2xl w-full">
        <div className="text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            Initial budget set to{" "}
            <span className="font-semibold text-foreground">
              {scores.monthlyBudget} kg CO₂e / month
            </span>
            .
          </p>
        </div>
        ...
        <ul className="mt-10 space-y-3">
          {summary.map((s) => (
            <li
              key={s.label}
              className="flex items-center gap-4 rounded-2xl border border-border bg-card p-4 ring-soft"
            >
              ...
              <span
                className={`text-[11px] uppercase tracking-wider rounded-full px-2.5 py-1 font-semibold ${
                  s.impact === "High"
